...
> **更新日期:** 2026-06-18
> **当前版本:** v11.0.0
> **项目状态:** v11.0 全面视觉统一与交互优化已完成；基于 v10.0 新增全局色彩统一、排序序号标识、字典树动画重设计、页面视觉与交互体验提升
> **验证基线:** Lint 0 errors / Build 成功 / 2996 单元测试通过（187 文件） / TypeScript strict 模式 / Bundle 预算符合
...
| Vitest | 4.1 | 单元测试（2996 tests / 187 文件） |
...
| 单元测试 | ✅ | 2978 tests / 187 文件（v10.0 coverage） |
