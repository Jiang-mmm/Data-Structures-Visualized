...
> **版本:** v19 i18n 渐进迁移 M0+M1 进行中（基于 v17.0.0 GA）
> **更新日期:** 2026-06-22
> **状态:** v17.0.0 GA 已 merge main（commit `b991566`）→ v18 计划已封存（2026-06-22） → v19 M0 拍板 + M1 调研清单已交付（commit `36d110e`） → 待 M2 启动拍板（D6/D7/D8）
