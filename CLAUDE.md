...
| 计划 | 路径 | 状态 | 启动条件 |
|------|------|------|----------|
| **v21 阶段执行计划** | [docs/superpowers/plans/2026-06-24-v21-execution-plan.md](docs/superpowers/plans/2026-06-24-v21-execution-plan.md) | 🟢 **A3 typecheck 修复完工**（feature/v21-b4b5-typecheck @ `be33345` — 1 file / +2 -2 / typecheck 2 pre-existing → 0 / 5 项硬门槛全过 / VERIFICATION: PASS）| 按用户「ABC 全选（并行）」拍板 2026-06-24；4 子任务 §7.2.1 B 并行；A1 (B-6 覆盖率 2-3d) / A2 (B-10 Dependabot 0.5d) / B (B-7 翻译 5d) 待用户对关键决策点拍板；C (design-md/ `.gitignore`) 用户拍板 C 先跳过保留悬而未决 |
| **v20.1.0 patch 发布** | [docs/superpowers/plans/2026-06-23-v20-1-patch-implementation-plan.md](docs/superpowers/plans/2026-06-23-v20-1-patch-implementation-plan.md) | ✅ **已发布到 origin 2026-06-23**（main @ `edaaf95` + tag `v20.1.0 @ e3bae56` 已 push；[release report](./../superpowers/plans/2026-06-23-v20-1-release-report.md) 11 章节 / GitHub Release Notes 草稿就绪待用户 UI 创建）| 详细：[v20.1.0 release report](./../superpowers/plans/2026-06-23-v20-1-release-report.md) §3 5 项硬门槛 4/5 + §5 移交 v21 候选 B-6/B-7/B-8/B-9/B-10（Dependabot）|
| **v20 第二轮执行计划** | [docs/superpowers/plans/2026-06-22-v20-round2-execution-plan.md](docs/superpowers/plans/2026-06-22-v20-round2-execution-plan.md) | ✅ **已被 v20.1.0 patch 收尾 2026-06-23** | 4/7 子阶段合并（C-1 + C-4 + A M7 + C-2 收尾）；3/7 移交 v21 候选（A M8 / A M9 / v20.0.0 GA）|
| **v20 下一迭代计划** | [docs/superpowers/plans/2026-06-22-v20-next-iteration-plan.md](docs/superpowers/plans/2026-06-22-v20-next-iteration-plan.md) | ✅ **由 v20.1.0 patch 替代 2026-06-23** | 选项 C：重新规划 v20.1 patch（绕过 A M8/M9）已拍板；3 方向 B-6/B-7/B-8/B-9/B-10 列入 v21 候选 |
