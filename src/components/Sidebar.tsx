...
function getIconSvg(index: number): ReactNode {
  ...
  switch (index) {
    ...
    case 13: // Trie - root with branches
    ...
    case 14: // SkipList - multi-level linked list
    ...
    case 15: // Compare - two bar charts
