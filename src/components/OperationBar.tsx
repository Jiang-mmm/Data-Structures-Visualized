...
export const OperationButton = memo(({ onClick, disabled, variant = 'primary', popAnimation = false, children, className = '', ...rest }: OperationButtonProps) => {
  ...
  const variants: Record<string, string> = {
    primary: 'bg-accent-blue border-accent-blue text-paper hover:bg-blue-600 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#1a1a2e] dark:hover:shadow-[3px_3px_0px_#334155] hover:brightness-110',
    success: 'bg-accent-emerald border-accent-emerald text-paper hover:bg-emerald-600 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#1a1a2e] dark:hover:shadow-[3px_3px_0px_#334155] hover:brightness-110',
    danger: 'bg-accent-rose border-accent-rose text-paper hover:bg-rose-600 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#1a1a2e] dark:hover:shadow-[3px_3px_0px_#334155] hover:brightness-110',
    warning: 'bg-accent-amber border-accent-amber text-paper hover:bg-amber-600 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#1a1a2e] dark:hover:shadow-[3px_3px_0px_#334155] hover:brightness-110',
    purple: 'bg-accent-violet border-accent-violet text-paper hover:bg-violet-600 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#1a1a2e] dark:hover:shadow-[3px_3px_0px_#334155] hover:brightness-110',
    teal: 'bg-accent-teal border-accent-teal text-paper hover:bg-teal-600 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#1a1a2e] dark:hover:shadow-[3px_3px_0px_#334155] hover:brightness-110',
    outline: 'bg-white dark:bg-slate border-ink/60 dark:border-dark-border text-ink dark:text-dark-ink hover:bg-paper-warm dark:hover:bg-slate-light hover:border-ink dark:hover:border-dark-ink hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#1a1a2e] dark:hover:shadow-[3px_3px_0px_#334155]',
  }
