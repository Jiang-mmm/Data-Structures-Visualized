...
- **v21 阶段执行计划（🟢 启动 2026-06-24）**：[`docs/superpowers/plans/2026-06-24-v21-execution-plan.md`](docs/superpowers/plans/2026-06-24-v21-execution-plan.md) — 按用户「ABC 全选（并行）」拍板：✅ **A3 typecheck 修复完工**（`be33345` / 1 file / +2 -2 / typecheck 2 pre-existing → 0 / 5 项硬门槛全过 / VERIFICATION: PASS）→ 🟡 A1 (B-6 覆盖率补完 2-3d) / A2 (B-10 Dependabot 0.5d) / B (B-7 翻译填充 5d) 待用户对关键决策点拍板 → ❌ C (design-md/ `.gitignore`) 用户拍板 C 先跳过保留悬而未决。
...
- **v20 下一迭代计划**：[`docs/superpowers/plans/2026-06-22-v20-next-iteration-plan.md`](docs/superpowers/plans/2026-06-22-v20-next-iteration-plan.md) — ✅ **由 v20.1.0 patch 替代 2026-06-23**（选项 C：绕过 A M8/M9 拍板；3 方向 B-6/B-7/B-8/B-9/B-10 列入 v21 候选）。
